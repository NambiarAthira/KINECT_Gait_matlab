function [final Z verticesX verticesY]=bsub4 (testdepthFrame,testrgbFrame,backgroundFrame,width)
...
% cd 'D:\Kinect_Softwares\1801\15';

% testrgbFrame='rgbframe300.png';
% testdepthFrame='frame300.png';
...
% subplot(3,3,5)
% imshow(Z),hold on, title(' New mask alligned with depthImage/Foreground RGB silhouette)')
% plot(verticesX, verticesY, 'r-', 'LineWidth', 2);
% plot(verticesX_new, verticesY_new, 'm-', 'LineWidth', 2);
